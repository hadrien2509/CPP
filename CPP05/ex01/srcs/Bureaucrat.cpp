...
/*   Updated: 2023/08/23 20:54:12 by hgeissle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &src)
{
	if (src.isItSigned())
		...
		std::cout << this->_name << " couldn't sign " << src.getName() << " because his hierarchical position is too low.... he needs to ask his manager" << std::endl;
}
